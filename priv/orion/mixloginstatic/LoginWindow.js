...
define(['domReady', 'orion/xhr', 'orion/PageUtil', 'orion/webui/littlelib', 'persona/include'], function(domReady, xhr, PageUtil, lib) {
	...
	function confirmResetUser() {
		...
		mypostrequest.open("PUT", "../useremailconfirmation", true);
	...
	function confirmLogin(login, password) {
		...
		if( login.length > 0 && password.length > 0 ){ 
			...
			mypostrequest.open("PUT", "../login/form", true);
			mypostrequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			mypostrequest.setRequestHeader("Orion-Version", "1");
	...
	function confirmCreateUser() {
		...
		mypostrequest.open("PUT", "../users/new", true);
		mypostrequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		mypostrequest.setRequestHeader("Orion-Version", "1");
		mypostrequest.send(parameters);
	}
	...
	domReady(function() {
		...
		checkusersrequest.open("PUT", "../login/canaddusers", true);
		...
		checkemailrequest.open("PUT", "../useremailconfirmation/cansendemails", true);
